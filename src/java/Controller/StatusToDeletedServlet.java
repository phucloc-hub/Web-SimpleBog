 ...
 * @author Loc
 */
public class StatusToDeletedServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = dao.deletedArticle(ArticleID);
            if (result == false) {
                url = ERROR_P;
...
//                listdto = dao.searchArticleByAd(status, typeSearch, searchVal);
//            } else {
...
//            out.println("</html>");
            ...
            log("SQLException_StatusToDeletedServlet:  " + ex.getMessage());
        } catch (ClassNotFoundException ex) {
            log("ClassNotFoundException_StatusToDeletedServlet:  " + ex.getMessage());
        } catch (NamingException ex) {
            log("NamingException_StatusToDeletedServlet:  " + ex.getMessage());
        } finally {
